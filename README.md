...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p a414a532-2e7a-4ae6-a60d-e77a4daafd61
```

> `a414a532-2e7a-4ae6-a60d-e77a4daafd61` is the password of the certificate, you can change it to any password you want.
