...
using baitapabp.Menus;
using baitapabp.Permissions;
...
public class baitapabpModule : AbpModule
{
    ...
    private void ConfigureVirtualFiles(IWebHostEnvironment hostingEnvironment)
    {
        ...
        {
            options.FileSets.AddEmbedded<baitapabpModule>();
            if (hostingEnvironment.IsDevelopment())
            {
                /* Using physical files in development, so we don't need to recompile on changes */
                options.FileSets.ReplaceEmbeddedByPhysical<baitapabpModule>(hostingEnvironment.ContentRootPath);
            }
        });
    }
    ...
    private void ConfigureAutoApiControllers()
    {
        ...
        {
            options.ConventionalControllers.Create(typeof(baitapabpModule).Assembly);
        });
    }
    ...
    {
        context.Services.AddAutoMapperObjectMapper<baitapabpModule>();
        Configure<AbpAutoMapperOptions>(options =>
        {
             ...
             */
            options.AddMaps<baitapabpModule>(/* validate: true */);
        });
    }
    ...
    private void ConfigureNavigationServices()
    {
        ...
        {
            options.MenuContributors.Add(new baitapabpMenuContributor());
        });

        Configure<AbpToolbarOptions>(options =>
        {
            options.Contributors.Add(new baitapabpToolbarContributor());
        });
    }
    ...
    public override async Task OnApplicationInitializationAsync(ApplicationInitializationContext context)
    {
        ...
        // 🟢 GỌI SEEDER SAU KHI ỨNG DỤNG KHỞI ĐỘNG
